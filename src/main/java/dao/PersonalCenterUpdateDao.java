...
public class PersonalCenterUpdateDao {
    private PreparedStatement pStmt = null;
    private ResultSet rs = null;
    private Connection con = null;
    public int userUpdate(PersonalCenterPojo personalcenterpojo){
        int count = 0;
        try{
            con = DBConnection.getConnection();
            pStmt = con.prepareStatement("UPDATE t_user SET password=?,rname=?,age=?,telphone=?,place=?,sex=? WHERE uname=?");
            pStmt.setString(1,personalcenterpojo.getUserpassword());
            pStmt.setString(7,personalcenterpojo.getUsername());
            pStmt.setString(2,personalcenterpojo.getRealname());
            pStmt.setInt(3,personalcenterpojo.getAge());
            pStmt.setString(4,personalcenterpojo.getTelphone());
            pStmt.setString(5,personalcenterpojo.getPlace());
            pStmt.setString(6,personalcenterpojo.getSex());
     ...
     *宠物信息管理方法
     * */
    public static class PetManageDao {
        ...
        public int adminDeletePetInformantionById(int PetId) throws SQLException {
            ...
            //先删除pet
            String sql1 = "delete from t_pet where pet_id= ? ;";
            //再删除相关领养
            String sql2 = "delete from t_adopt where pet_id=?;";
            try {
                con.prepareStatement(set0);
